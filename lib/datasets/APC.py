...
class APC(imdb):
    def __init__(self, image_set, devkit_path):
        ...
        'creativity_chenille_stems','hanes_tube_socks','laugh_out_loud_joke_book','kyjen_squeakin_eggs_plush_puppies','cloud_b_plush_bear')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_APC_annotation(index)
    ...
    def _load_APC_annotation(self, index):
        """
        Load image and bounding boxes info from XML file in the APC
        format.
        """
